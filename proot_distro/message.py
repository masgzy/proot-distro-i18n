...
def msg(*args):
    ...
    The `\r\033[K` progress-line eraser is only emitted when stderr is
...
def log_info(text: str):
    ...
    *text* must already be passed through ``_()`` by the caller; this
    function only handles coloring and the quiet bypass.
    """
    if _quiet:
        return
