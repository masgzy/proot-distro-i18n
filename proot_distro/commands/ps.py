...
def command_ps(args) -> None:
    ...
    msg()
    if not sessions:
        msg(_("{_arg0}No active sessions.{_arg1}", _arg0 = C['YELLOW'], _arg1 = C['RST']))
        msg()
    ...
    msg(_("{_arg0}{_arg1}{_arg2}", _arg0 = C['UBCYAN'], _arg1 = pad.join(head), _arg2 = C['RST']))
    ...
    if any_detached:
        msg()
        msg(_("{_arg0}* detached session{_arg1}", _arg0 = C['YELLOW'], _arg1 = C['RST']))
    msg()
