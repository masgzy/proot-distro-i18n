...
def active_sessions():
    ...
    for name in names:
        ...
        # Probe liveness *before* reading JSON — a dead session file
        # gets unlinked without an expensive open+json.load. This also
        # avoids reading JSON for sessions that are about to be pruned.
        ...
        try:
            ...
            # Session is alive (passed _session_alive) but JSON is
            # corrupt — skip without pruning, since the owning process
